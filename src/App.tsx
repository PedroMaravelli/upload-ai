    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4 ">
          ...
          <p>Lembre-se: você pode utilizar a variável <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transcrição do video selecionado</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">
                Valores mais altos tendem a deixar o resulatdo mais criativo e com possíveis erros 
              </span>
